...
# For use specifically with the Tayside directories in Crypt.
...
train_output_file = '/disk/data2/radiology/users/scassady/data/finetuning/tay-merge/train.tsv'
# eval_output_file = '/disk/data2/radiology/users/scassady/data/finetuning/tay-merge/dev.tsv'
test_output_file = '/disk/data2/radiology/users/scassady/data/finetuning/tay-merge/test.tsv'
# ID_prefix = "D"
